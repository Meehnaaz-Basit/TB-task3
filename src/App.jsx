    ...
    <div className="">
      ...
      <div className="grid grid-cols-12 relative">
        ...
        <div className="lg:col-span-7  flex items-center justify-center z-10 bg-transparent bottom-0 mx-auto  ">
          {!openModal && (
            <h3 className="hidden lg:block">Click any card to view details</h3>
          )}

          {selectedUser && openModal && (
            <div className="space-y-1 lg:w-[500px] lg:h-[400px] text-primary lg:relative absolute right-0 lg:top-0 lg:right-0 top-1/3 left-0 bottom-0 shadow-md shadow-violet-500 p-4 sm:p-8 lg:p-10 bg-black break-words rounded-lg border border-violet-500">
              ...
              <h2 className="font-medium">
                ...
                <span className="text-gray-400 font-normal">
                  {selectedUser?.profile?.username || "No data to show"}
                </span>
              </h2>
              <p className="font-medium">
                First Name:{" "}
                <span className="text-gray-400 font-normal">
                  {selectedUser?.profile?.firstName || "No data to show"}
                </span>
              </p>
              <p className="font-medium">
                Last Name:{" "}
                <span className="text-gray-400 font-normal">
                  {selectedUser?.profile?.lastName || "No data to show"}
                </span>
              </p>
              <p className="font-medium">
                Email:{" "}
